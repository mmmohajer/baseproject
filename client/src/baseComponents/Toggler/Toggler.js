    ...
    <>
      <Div type="flex" vAlign="center">
        <Div
          type="flex"
          vAlign="center"
          className="height-px-20 width-px-40 bgWhite br-rad-px-10 of-hidden mouse-hand pos-rel"
          onClick={() => {
            if (activeState === 1) {
              setActiveState(2);
            }
